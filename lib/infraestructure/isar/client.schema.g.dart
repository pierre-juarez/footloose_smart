...
void _clientSerialize(
  ...
  writer.writeLong(offsets[0], object.idCliente);
...
Client _clientDeserialize(
  ...
  final object = Client();
  object.id = id;
  object.idCliente = reader.readLongOrNull(offsets[0]);
...
extension ClientQueryFilter on QueryBuilder<Client, Client, QFilterCondition> {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteEqualTo(
      int? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'idCliente',
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteGreaterThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteLessThan(
    int? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> idClienteBetween(
    int? lower,
    int? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> nameIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'name',
      ));
  ...
  QueryBuilder<Client, Client, QAfterFilterCondition> nameIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'name',
      ));
...
extension ClientQuerySortBy on QueryBuilder<Client, Client, QSortBy> {
  QueryBuilder<Client, Client, QAfterSortBy> sortByIdCliente() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idCliente', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> sortByIdClienteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ClientQuerySortThenBy on QueryBuilder<Client, Client, QSortThenBy> {
  ...
  QueryBuilder<Client, Client, QAfterSortBy> thenByIdCliente() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idCliente', Sort.asc);
    });
  }

  QueryBuilder<Client, Client, QAfterSortBy> thenByIdClienteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idCliente', Sort.desc);
    });
  }
...
extension ClientQueryWhereDistinct on QueryBuilder<Client, Client, QDistinct> {
  QueryBuilder<Client, Client, QDistinct> distinctByIdCliente() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'idCliente');
    });
  }
...
extension ClientQueryProperty on QueryBuilder<Client, Client, QQueryProperty> {
  ...
  QueryBuilder<Client, int?, QQueryOperations> idClienteProperty() {
    return QueryBuilder.apply(this, (query) {
